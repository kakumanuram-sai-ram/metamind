...
-- Chart 2: 3P online top 1k Daily Summary (ID: 3157)
-- Chart Type: table
-- Dataset: 3P_online_top_1k_agg_summary
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 3: 3P Online - Overall MTD LMTD FT RT Summary (ID: 3462)
-- Chart Type: table
...
-- Chart 4: 3P Online - Overall MTD LMTD FT RT Summary (ID: 3462)
-- Chart Type: table
-- Dataset: 3P online ft rt overall MTD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 5: FT/RT DoD Merchant Level (Apply Merchant filter on top for any specific merchant) (ID: 3463)
-- Chart Type: table
...
-- Chart 6: FT/RT DoD Merchant Level (Apply Merchant filter on top for any specific merchant) (ID: 3463)
-- Chart Type: table
-- Dataset: 3P online FT RT Merchant Level
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 7: online_category_missingvpa_mapping (ID: 3562)
-- Chart Type: table
...
-- Chart 8: online_category_missingvpa_mapping (ID: 3562)
-- Chart Type: table
-- Dataset: online_category_missingvpa_mapping
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 9: MTU_Live_Non_Live_Top_15_ (ID: 6505)
-- Chart Type: table
-- Dataset: Live_NonLive_MTU_3P_Online
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('day', CAST(mnt AS TIMESTAMP)) AS mnt, sum(overall_mtu) AS "Overall_MTU__", sum(live_merchants) AS "Live_Merch_MTU", sum(non_live_exc_live) AS "Non_Live_MTU(excld_Live)", sum("Top_15_merc") AS "Top_15_Merch_MTU", sum("Top_1K_MTU") AS "Top_1K_MTU" 
FROM (with base_ as (
select
mnt,
payer_cust_id,
...
-- Chart 10: MTU_Live_Non_Live_Top_15_ (ID: 6505)
-- Chart Type: table
-- Dataset: Live_NonLive_MTU_3P_Online
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 11: FT/RT DoD Merchant Level (Top 15) (ID: 6680)
-- Chart Type: table
-- Dataset: 3P online FT RT Merchant Level
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 12: FT/RT DoD Merchant Level (Top 15) (ID: 6680)
-- Chart Type: table
-- Dataset: 3P online FT RT Merchant Level
-- Database: Trino
--------------------------------------------------------------------------------
