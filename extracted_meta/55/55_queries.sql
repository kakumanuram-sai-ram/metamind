-- SQL Queries for Dashboard: Care Dashboard-MHD
-- Dashboard ID: 55
-- Total Charts: 144
================================================================================

-- Chart 1: QS_SB Pendency_final_stage_eventtime (ID: 188)
-- Chart Type: pivot_table_v2
-- Dataset: QR_SB_Pendecy_TBL
-- Database: Trino
--------------------------------------------------------------------------------
WITH subquery AS (
  SELECT
...
-- Chart 2: QS_SB Pendency_final_stage_eventtime (ID: 188)
-- Chart Type: pivot_table_v2
-- Dataset: QR_SB_Pendecy_TBL
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 3: QS_SB Pendency_final_substage_eventtime (ID: 190)
-- Chart Type: pivot_table_v2
-- Dataset: QR_SB_Pendency_TBL
-- Database: Trino
--------------------------------------------------------------------------------
SELECT days_bucket AS days_bucket, final_stage AS final_stage, substage AS substage, count(id) AS "COUNT(id)" 
...
-- Chart 4: QS_SB Pendency_final_substage_eventtime (ID: 190)
-- Chart Type: pivot_table_v2
-- Dataset: QR_SB_Pendency_TBL
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 5: Bot Tickets Counts (Includes Dropoff) (ID: 226)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(bot_ticket_count) AS "SUM(bot_ticket_count)" 
...
-- Chart 6: Bot Tickets Counts (Includes Dropoff) (ID: 226)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 7: Bot Tickets Count (Active Sessions) (ID: 227)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(bot_active_ticket_count) AS "SUM(bot_active_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 8: Bot Tickets Count (Active Sessions) (ID: 227)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 9: Bot MSAT (%) (ID: 228)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*SUM(bot_positive_response)/nullif(SUM(bot_total_responses),0) AS "100*SUM(bot_positive_response)/nullif(SUM(bot_total_responses),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 11: Bot Passthrough (%) (ID: 229)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*SUM(agent_ticket_count_bot)/NULLIF(SUM(bot_active_ticket_count),0) AS "100*SUM(agent_ticket_count_bot)/NULLIF(SUM(bot_active_ticket_count),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 12: Bot Passthrough (%) (ID: 229)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 13: IVR Calls Count (ID: 230)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(ivr_calls) AS "SUM(ivr_calls)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 14: IVR Calls Count (ID: 230)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 15: Ticket Count (MHD+Service) (ID: 232)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(total_ticket_count) AS "SUM(total_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 16: Ticket Count (MHD+Service) (ID: 232)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 17: Ticket Count (MHD Agent) (ID: 233)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(agent_ticket_count) AS "SUM(agent_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 18: Ticket Count (MHD Agent) (ID: 233)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 19: Ticket Count (Service) (ID: 234)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(service_ticket_count) AS "SUM(service_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 20: Ticket Count (Service) (ID: 234)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 21: MSAT(%) Agent (ID: 236)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100 * SUM(agent_tickets_msat_received) / NULLIF(SUM(agent_tickets_feedback_received), 0) AS "100 * SUM(agent_tickets_msat_received) / NULLIF(SUM(agent_tickets_feedback_received), 0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table 
...
-- Chart 23: MSAT (%) (MHD+Service) (ID: 237)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100 * SUM(total_tickets_msat_received) / NULLIF(SUM(total_tickets_feedback_received), 0) AS "100 * SUM(total_tickets_msat_received) / NULLIF(SUM(total_tickets_feedback_received), 0)
" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table 
WHERE (lob NOT IN ('06. RETAIL MID-MARKET', '07. ENTERPRISE', '08. GOVERNMENT')) GROUP BY lob
...
-- Chart 24: MSAT (%) (MHD+Service) (ID: 237)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 25: MSAT(%) Service (ID: 238)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100 * SUM(service_tickets_msat_received) / 
...
-- Chart 27: Avg TAT (Days) Human Agent (ID: 239)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(sum_tat_days)/
...
-- Chart 28: Avg TAT (Days) Human Agent (ID: 239)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 29: Unique Merchant Count - Bot (ID: 247)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(bot_merchant_count) AS "Bot (Active+Dropoff)", sum(bot_active_merchant_count) AS "Bot- Active Sessions" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 30: Unique Merchant Count - Bot (ID: 247)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 31: Top Issue on Bot  (ID: 251)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT issue_mapping AS issue_mapping, sum(bot_active_ticket_count) AS "SUM(bot_active_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 32: Top Issue on Bot  (ID: 251)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 33: Agent Ticket Count - Bot (MHD & Service) (ID: 252)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(agent_ticket_count_bot) AS "MHD Agent", sum(bot_to_service_ticket_count) AS "Service" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 34: Agent Ticket Count - Bot (MHD & Service) (ID: 252)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 35: Unique Merchant Counts - Bot (MHD & Service) (ID: 253)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(agent_ticket_merchant_count_bot) AS "MHD Agent", sum(bot_to_service_ticket_merchant_count) AS "Service" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "MHD Agent" DESC
LIMIT 10000;
...
-- Chart 36: Unique Merchant Counts - Bot (MHD & Service) (ID: 253)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 37: Bot Passthrough % (MHD & Service) (ID: 254)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, 100*SUM(agent_ticket_count_bot)/nullif(sum(bot_active_ticket_count),0) AS "MHD Agent", 100*SUM(bot_to_service_ticket_count)/nullif(sum(bot_active_ticket_count),0) AS "Serivce" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "MHD Agent" DESC
LIMIT 10000;
...
-- Chart 38: Bot Passthrough % (MHD & Service) (ID: 254)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 39: Feedback % - Bot (ID: 255)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, 100*SUM(bot_total_responses)/nullif(sum(bot_active_ticket_count),0) AS "Response Rate", 100*SUM(bot_positive_response)/nullif(SUM(bot_total_responses),0) AS "MSAT" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 41: Feedback % (Human Agent) (ID: 258)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, 100*SUM(total_tickets_feedback_received)/nullif(sum(total_tickets_for_response),0) AS "Response Rate", 100 * SUM(total_tickets_msat_received) / NULLIF(SUM(total_tickets_feedback_received), 0) AS "MSAT" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "Response Rate" DESC
LIMIT 10000;
...
-- Chart 42: Feedback % (Human Agent) (ID: 258)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 43: Feedback % - MHD Agent  (ID: 260)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, 100 * SUM(agent_tickets_feedback_received) / NULLIF(SUM(agent_tickets_for_response), 0) AS "Response Rate", 100 * SUM(agent_tickets_msat_received) / NULLIF(SUM(agent_tickets_feedback_received), 0) AS "MSAT" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "Response Rate" DESC
LIMIT 10000;
...
-- Chart 44: Feedback % - MHD Agent  (ID: 260)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 45: Feedback % - Service (ID: 262)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, 100 * SUM(service_tickets_feedback_received) / 
...
-- Chart 46: Feedback % - Service (ID: 262)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 47: Avg TAT (Days) - Human Agent (ID: 264)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(sum_tat_days)/
nullif(SUM(tat_denominatior_tickets),0) AS "sum(sum_tat_days)/
nullif(SUM(tat_denominatior_tickets),0)
" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 48: Avg TAT (Days) - Human Agent (ID: 264)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 49: Avg TAT (Days) - MHD Agent (ID: 265)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(sum_mhd_tat_days)/
...
-- Chart 50: Avg TAT (Days) - MHD Agent (ID: 265)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 51: Avg TAT - Service Agent (ID: 266)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(sum_service_tat_days)/nullif(
...
-- Chart 52: Avg TAT - Service Agent (ID: 266)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 53: Top L1 Issues - Human Agent (ID: 269)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT issue_mapping AS issue_mapping, sum(total_ticket_count) AS "SUM(total_ticket_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY issue_mapping
LIMIT 10000;
...
-- Chart 54: Top L1 Issues - Human Agent (ID: 269)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 55: Ticket Counts - Bot (ID: 270)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(bot_ticket_count) AS "BOT (Active+Drop off)", sum(bot_active_ticket_count) AS "Bot - Active Session" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 56: Ticket Counts - Bot (ID: 270)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 57: Bot Contact Ratio (%) (ID: 386)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*SUM(bot_ticket_count)/nullif(max(cr_base_count),0) AS "100*SUM(bot_ticket_count)/nullif(max(cr_base_count),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 58: Bot Contact Ratio (%) (ID: 386)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 59: Total Volume (IVR Calls+Bot Tickets) (ID: 387)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(bot_ticket_count)+SUM(ivr_calls) AS "sum(bot_ticket_count)+SUM(ivr_calls)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 60: Total Volume (IVR Calls+Bot Tickets) (ID: 387)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 61: Contact Ratio (%) (ID: 388)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*(SUM(bot_ticket_count)+sum(ivr_calls))/
...
-- Chart 63: MSAT (%) (ID: 389)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*((SUM(bot_positive_response)+SUM(total_tickets_msat_received)))/nullif((SUM(bot_total_responses)+SUM(total_tickets_feedback_received)),0) AS "100*((SUM(bot_positive_response)+SUM(total_tickets_msat_received)))/nullif((SUM(bot_total_responses)+SUM(total_tickets_feedback_received)),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 65: IVR Contact Ratio (%) (ID: 390)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*sum(ivr_calls)/nullif(max(cr_base_count),0) AS "100*sum(ivr_calls)/nullif(max(cr_base_count),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 66: IVR Contact Ratio (%) (ID: 390)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 67: Avg TAT (Days) Service Agent (ID: 391)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(sum_service_tat_days)/
...
-- Chart 68: Avg TAT (Days) Service Agent (ID: 391)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 69: Avg TAT (Days) MHD Agent (ID: 392)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(sum_mhd_tat_days)/
nullif(SUM(mhd_tat_denominatior_tickets),0) AS "sum(sum_mhd_tat_days)/
nullif(SUM(mhd_tat_denominatior_tickets),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
...
-- Chart 70: Avg TAT (Days) MHD Agent (ID: 392)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 71: Bot Contact Ratio (%) (ID: 393)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('month', CAST(created_date AS TIMESTAMP)) AS created_date, 100*SUM(bot_ticket_count)/nullif(max(cr_base_count),0) AS "Bot (Active+Dropoff)", 100*SUM(bot_active_ticket_count)/nullif(max(cr_base_count),0) AS "Bot - Active Sessions" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 72: Bot Contact Ratio (%) (ID: 393)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 73: Top Bot L2 Issues (ID: 398)
-- Chart Type: time_table
-- Dataset: MHD_Bot_L2_Data
-- Database: Trino
--------------------------------------------------------------------------------
SELECT bot_l2 AS bot_l2, sum(bot_active_ticket_count) AS "SUM(bot_active_ticket_count)" 
...
-- Chart 74: Top Bot L2 Issues (ID: 398)
-- Chart Type: time_table
-- Dataset: MHD_Bot_L2_Data
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 75: Top DSAT Reason -  Bot (ID: 401)
-- Chart Type: time_table
-- Dataset: MHD_Bot_L2_Data
-- Database: Trino
--------------------------------------------------------------------------------
SELECT bot_l2 AS bot_l2, sum(bot_negative_response) AS "sum(bot_negative_response)" 
FROM (select * from hive.team_servicesone.Bot_issue_l2_project_servicesone_mhd
) AS virtual_table GROUP BY bot_l2
LIMIT 10000;
...
-- Chart 76: Top DSAT Reason -  Bot (ID: 401)
-- Chart Type: time_table
-- Dataset: MHD_Bot_L2_Data
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 77: Top L2 Issues - Human Agent (ID: 404)
-- Chart Type: time_table
-- Dataset: MHD_Agent_Tickets_Issue_Data
-- Database: Trino
--------------------------------------------------------------------------------
SELECT issue_l2 AS issue_l2, sum(total_ticket_count) AS "SUM(total_ticket_count)" 
...
-- Chart 78: Top L2 Issues - Human Agent (ID: 404)
-- Chart Type: time_table
-- Dataset: MHD_Agent_Tickets_Issue_Data
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 79: Intent wise Final MSAT % (ID: 429)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('day', CAST(date_ AS TIMESTAMP)) AS date_, cst_entity AS cst_entity, CASE 
...
-- Chart 80: Intent wise Final MSAT % (ID: 429)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 81: Function Call SR% (ID: 430)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('day', CAST(date_ AS TIMESTAMP)) AS date_, CASE 
...
-- Chart 82: Function Call SR% (ID: 430)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 83: Bot to Service Passthrough (%) (ID: 496)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, 100*SUM(bot_to_service_ticket_count)/NULLIF(SUM(bot_active_ticket_count),0) AS "100*SUM(bot_to_service_ticket_count)/NULLIF(SUM(bot_active_ticket_count),0)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 84: Bot to Service Passthrough (%) (ID: 496)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 85: MHD Agent Tickets count (IVR) (ID: 497)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(agent_ticket_count_phone) AS "SUM(agent_ticket_count_phone)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 86: MHD Agent Tickets count (IVR) (ID: 497)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 87: Service Tickets Count (IVR) (ID: 498)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT lob AS lob, sum(ivr_call_to_service_ticket) AS "SUM(ivr_call_to_service_ticket)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY lob
LIMIT 10000;
...
-- Chart 88: Service Tickets Count (IVR) (ID: 498)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 89: IVR Calls Count (ID: 499)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(ivr_calls) AS "SUM(ivr_calls)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 90: IVR Calls Count (ID: 499)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 91: Unique Merchant Count - IVR (ID: 500)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(ivr_merchant_count) AS "SUM(ivr_merchant_count)" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 92: Unique Merchant Count - IVR (ID: 500)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 93: IVR Contact Ratio (%) (ID: 501)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('month', CAST(created_date AS TIMESTAMP)) AS created_date, 100*SUM(ivr_calls)/nullif(max(cr_base_count),0) AS "100*SUM(ivr_calls)/nullif(max(cr_base_count),0)
" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
...
-- Chart 94: IVR Contact Ratio (%) (ID: 501)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 95: MHD Agent Ticket Count - IVR (ID: 502)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(agent_ticket_count_phone) AS "MHD Agent", SUM(ivr_to_service_ticket_count) AS "Service" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "MHD Agent" DESC
LIMIT 10000;
...
-- Chart 96: MHD Agent Ticket Count - IVR (ID: 502)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 97: Unique Merchant Count - MHD Agent (IVR) (ID: 503)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('week', CAST(created_date AS TIMESTAMP)) AS created_date, sum(agent_ticket_merchant_count_phone) AS "MHD Agent", SUM(ivr_to_service_ticket_merchant_count) AS "Service" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table GROUP BY date_trunc('week', CAST(created_date AS TIMESTAMP)) ORDER BY "MHD Agent" DESC
LIMIT 10000;
...
-- Chart 98: Unique Merchant Count - MHD Agent (IVR) (ID: 503)
-- Chart Type: echarts_timeseries_line
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 99: Monthly AVG Latency (seconds) (ID: 513)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
SELECT CASE month_
        WHEN 1 THEN 'January'
...
-- Chart 100: Monthly AVG Latency (seconds) (ID: 513)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 101: Monthly Median Latency (ID: 514)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 102: Monthly Median Latency (ID: 514)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 103: Monthly P95 Latency (ID: 515)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 104: Monthly P95 Latency (ID: 515)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 105: Monthly P99 Latency (ID: 516)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 106: Monthly P99 Latency (ID: 516)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 107: Monthly P90 Latency (ID: 517)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 108: Monthly P90 Latency (ID: 517)
-- Chart Type: echarts_timeseries_line
-- Dataset: CST MHD Latency
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 109: MHD Language Select - Last Week (ID: 519)
-- Chart Type: time_table
-- Dataset: CST MHD Language Select
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 110: MHD Language Select - Last Week (ID: 519)
-- Chart Type: time_table
-- Dataset: CST MHD Language Select
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 111: Agent Ticket Inflow (ID: 528)
-- Chart Type: table
-- Dataset: MHD_Agent_Tickets_Issue_Data
-- Database: Trino
--------------------------------------------------------------------------------
SELECT issue_l1 AS issue_l1, issue_l2 AS issue_l2, sum(total_ticket_count) AS "Total Ticket Count", sum(agent_ticket_count) AS "MHD Agent", sum(service_ticket_count) AS "Service", sum(sum_tat_days)/
...
-- Chart 112: Agent Ticket Inflow (ID: 528)
-- Chart Type: table
-- Dataset: MHD_Agent_Tickets_Issue_Data
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 113: MSAT + Fedback Given % (ID: 529)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 114: MSAT + Fedback Given % (ID: 529)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 115: Intent wise Tickets Creation % (ID: 530)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('day', CAST(date_ AS TIMESTAMP)) AS date_, CASE WHEN SUM(p4bbusinessloan_tickets) = 0 THEN NULL
...
-- Chart 116: Intent wise Tickets Creation % (ID: 530)
-- Chart Type: echarts_timeseries_smooth
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 117: Function Calls # (ID: 531)
-- Chart Type: table
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 118: Function Calls # (ID: 531)
-- Chart Type: table
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 119: Language Change Metrics (ID: 554)
-- Chart Type: table
-- Dataset: Language Transition
-- Database: Trino
--------------------------------------------------------------------------------
SELECT language_transition AS language_transition, sum(transition_count) AS "# Language Change", sum(transition_count) AS " Language Change" 
...
-- Chart 120: Language Change Metrics (ID: 554)
-- Chart Type: table
-- Dataset: Language Transition
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 121: Intent wise Bot MSAT % (ID: 568)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 122: Intent wise Bot MSAT % (ID: 568)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 123: Bot MSAT + Fedback Rate % (ID: 569)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 124: Bot MSAT + Fedback Rate % (ID: 569)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 125: Ticket MSAT + Feedback Rate % (ID: 570)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 126: Ticket MSAT + Feedback Rate % (ID: 570)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 127: Intent wise Ticket Only MSAT % (ID: 571)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 128: Intent wise Ticket Only MSAT % (ID: 571)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 129: Service Ticket MSAT + Feedback Rate % (ID: 572)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 130: Service Ticket MSAT + Feedback Rate % (ID: 572)
-- Chart Type: echarts_timeseries_line
-- Dataset: MHD MSAT Base
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 131: Bot CTR % (Distinct User Level) (ID: 578)
-- Chart Type: table
-- Dataset: Bot CTR
-- Database: Trino
--------------------------------------------------------------------------------
SELECT event_label2 AS "CTA", sum(users_shown) AS "CTA Displayed #", sum(users_clicked) AS "CTA Clicked #", CASE 
...
-- Chart 132: Bot CTR % (Distinct User Level) (ID: 578)
-- Chart Type: table
-- Dataset: Bot CTR
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 134: Weekly_Metrics_Insights_MHD (ID: 2122)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 135: Weekly_Metrics_Insights_1_MHD (ID: 2123)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 136: Weekly_Metrics_Insights_1_MHD (ID: 2123)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 137: Monthly_Metrics_Insights_MHD (ID: 2210)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
SELECT min(created_month) AS "Month of the year", sum(ivr_calls) AS "IVR Calls Count", ROUND(CAST(100 * SUM(ivr_calls) AS DECIMAL(18, 2)) / nullif(max(cr_base_count),0), 2) AS "IVR Contact Ratio (%)", sum(bot_ticket_count) AS "Bot Tickets Count", ROUND(CAST(100 * SUM(bot_ticket_count) AS DECIMAL(18, 2)) / nullif(max(cr_base_count),0), 2) AS "Bot Contact Ratio(%)", 100*SUM(bot_total_responses)/nullif(sum(bot_active_ticket_count),0) AS "Feedback % - Bot", 100*SUM(bot_positive_response)/nullif(SUM(bot_total_responses),0) AS "Bot MSAT(%)", 100*SUM(agent_ticket_count_bot)/NULLIF(SUM(bot_active_ticket_count),0) AS "Bot to MHD Passthrough(%)", 100 * SUM(agent_tickets_feedback_received) / NULLIF(SUM(agent_tickets_for_response), 0) AS "Feedback % - MHD Agent", 100*SUM(bot_to_service_ticket_count)/NULLIF(SUM(bot_active_ticket_count),0) AS "Bot to Service Passthrough (%)", SUM(agent_ticket_count_bot)+SUM(bot_to_service_ticket_count) AS "Agent Ticket Count - Bot (MHD & Service)", sum(agent_ticket_count_bot) AS "Agent Ticket Count - Bot MHD", sum(bot_to_service_ticket_count) AS "Agent Ticket Count- Bot Service", 100 * SUM(agent_tickets_msat_received) / NULLIF(SUM(agent_tickets_feedback_received), 0) AS " MSAT(%) MHD Agent" 
FROM (select * from hive.team_servicesone.combined_data_project_servicesone_mhd
) AS virtual_table
LIMIT 10000;
...
-- Chart 138: Monthly_Metrics_Insights_MHD (ID: 2210)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 139: Monthly_Metrics_Insights_MHD (ID: 2211)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 140: Monthly_Metrics_Insights_MHD (ID: 2211)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 141: Monthly_Metrics_Insights_MHD_ (ID: 2213)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 142: Monthly_Metrics_Insights_MHD_ (ID: 2213)
-- Chart Type: time_table
-- Dataset: combined_data_project_MHD
-- Database: Trino
--------------------------------------------------------------------------------
...
-- Chart 143: Monthly Sessions + Agent Handover + Service Tickets (ID: 518)
-- Chart Type: mixed_timeseries
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
SELECT date_trunc('month', CAST(DATE_TRUNC('month', date_) AS TIMESTAMP)) AS "Month", sum(active_sessions) AS "Active Sessions", sum(agent_tickets) AS "Agent Tickets", sum(service_tickets) AS "Service Tickets" 
FROM (SELECT * FROM "hive"."team_cst_mhd_product"."mhd_monthly_dashboard1" ORDER BY 1 DESC, 2 DESC, 4 DESC
) AS virtual_table 
...
-- Chart 144: Monthly Sessions + Agent Handover + Service Tickets (ID: 518)
-- Chart Type: mixed_timeseries
-- Dataset: MHD Summary Dataset - 05/22/2025
-- Database: Trino
--------------------------------------------------------------------------------
